        ...
        tables = {
            ...
            'users': '''
                CREATE TABLE IF NOT EXISTS users (
                    ...
                    permissions TEXT,
                    approved_warehouse VARCHAR(50),
                    approved_bin VARCHAR(50),
                    rejected_warehouse VARCHAR(50),
                    rejected_bin VARCHAR(50),
                    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
            ...
            'grpo_transfer_items': '''
                CREATE TABLE IF NOT EXISTS grpo_transfer_items (
                    ...
                    from_bin_abs_entry INT,
                    to_warehouse VARCHAR(50),
                    to_bin_code VARCHAR(100),
                    to_bin_abs_entry INT,
                    from_warehouse_abs_entry INT,
                    to_warehouse_abs_entry INT,
