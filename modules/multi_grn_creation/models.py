...
class Gs1Scan(db.Model):
    __tablename__ = "gs1_scans"
    ...
    mfg_date = db.Column(db.String(10))
    serial = db.Column(db.String(100))
    quantity = db.Column(db.String(50))
    variable_qty = db.Column(db.String(50))
    sscc = db.Column(db.String(18))
    internal_product = db.Column(db.String(100))
    internal_company = db.Column(db.String(100))
